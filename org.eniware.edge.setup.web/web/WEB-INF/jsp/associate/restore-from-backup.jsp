...
<form:form action="${action}" method="post" cssClass="form-horizontal span8" id="associate-restore-backup-form">
	<p><fmt:message key="Edge.setup.restore.imported.intro"/></p>	
	...
	<div class="form-actions">
		<button type="submit" class="btn btn-primary ladda-button expand-right"><fmt:message key='Edge.setup.restore.restore'/></button>
	</div>
	<sec:csrfInput/>
</form:form>
