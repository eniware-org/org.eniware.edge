...
<form:form modelAttribute="details" action="${action}" cssClass="form-horizontal" method="post">
	<fieldset>
		<div class="control-group">
			<label class="control-label" for="invitation-host"><fmt:message key="Edge.setup.identity.service"/></label>
			<div class="controls" id="invitation-host">
				<span class="uneditable-input span6">${details.host}</span>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="invitation-username"><fmt:message key="Edge.setup.identity.username"/></label>
			<div class="controls" id="invitation-username">
				<span class="uneditable-input span6">${details.username}</span>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="invitation-identity"><fmt:message key="Edge.setup.identity.identity"/></label>
